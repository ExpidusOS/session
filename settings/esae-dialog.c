...
static void esae_dialog_update (EsaeDialog *dialog);
static void esae_dialog_browse (EsaeDialog *dialog);



struct _EsaeDialogClass
{
...
G_DEFINE_TYPE (EsaeDialog, esae_dialog, GTK_TYPE_DIALOG)



static void
esae_dialog_class_init (EsaeDialogClass *klass)
{
}
...
static void
esae_dialog_init (EsaeDialog *dialog)
{
  ...
  g_signal_connect_swapped (G_OBJECT (dialog->name_entry), "notify::text",
                            G_CALLBACK (esae_dialog_update), dialog);
  ...
  g_signal_connect_swapped (G_OBJECT (button), "clicked",
                            G_CALLBACK (esae_dialog_browse), dialog);
...
static void
esae_dialog_update (EsaeDialog *dialog)
{
  const gchar *command;
  const gchar *name;
...
static void
esae_dialog_browse (EsaeDialog *dialog)
{
  const gchar *command;
  GtkWidget   *chooser;
  gchar       *filename;
 ...
 *
 * Allocates a new #EsaeDialog instance.
 *
 * Return value: the newly allocated #EsaeDialog.
 **/
GtkWidget*
esae_dialog_new (const gchar *name,
                 const gchar *descr,
                 const gchar *command,
                 EssmRunHook  run_hook)
{
  EsaeDialog *dialog = g_object_new (ESAE_TYPE_DIALOG, NULL);
 ...
 **/
void
esae_dialog_get (EsaeDialog   *dialog,
                 gchar       **name,
                 gchar       **descr,
                 gchar       **command,
                 EssmRunHook  *run_hook)
{
  g_return_if_fail (ESAE_IS_DIALOG (dialog));
