...
static void essm_chooser_row_activated (GtkTreeView       *treeview,
                                        GtkTreePath       *path,
                                        GtkTreeViewColumn *column,
                                        EssmChooser       *chooser);
static void essm_chooser_realized      (GtkWidget         *widget,
                                        EssmChooser       *chooser);



G_DEFINE_TYPE (EssmChooser, essm_chooser, GTK_TYPE_DIALOG)



void
essm_chooser_set_sessions (EssmChooser *chooser,
                           GList       *sessions,
...
static void
essm_chooser_new_session (GtkButton *button,
                          EssmChooser *chooser)
{
  gtk_dialog_response (GTK_DIALOG (chooser), ESSM_RESPONSE_NEW);
}


static void
essm_chooser_logout (GtkButton *button,
                     EssmChooser *chooser)
{
...
static void
essm_chooser_start_session (GtkButton *button,
                            EssmChooser *chooser)
{
  gtk_dialog_response (GTK_DIALOG (chooser), ESSM_RESPONSE_LOAD);
}


gchar*
essm_chooser_get_session (const EssmChooser *chooser)
{
...
static void
essm_chooser_class_init (EssmChooserClass *klass)
{
}


static void
essm_chooser_init (EssmChooser *chooser)
{
  GtkWidget *button;
  GtkWidget *swin;
  GtkWidget *vbox;
  ...
  g_signal_connect_after (G_OBJECT (chooser), "realize",
                          G_CALLBACK (essm_chooser_realized), chooser);
  ...
  g_signal_connect (G_OBJECT (chooser->tree), "row-activated",
                    G_CALLBACK (essm_chooser_row_activated), chooser);
  ...
  g_signal_connect (G_OBJECT (button), "clicked",
                    G_CALLBACK (essm_chooser_new_session), chooser);
  ...
  /* "Logout" button */
  button = expidus_gtk_button_new_mixed ("application-exit", _("Log Out"));
  gtk_widget_set_tooltip_text (button,
                               _("Cancel the login attempt and return to "
                                 "the login screen."));
  g_signal_connect (G_OBJECT (button), "clicked",
                    G_CALLBACK (essm_chooser_logout), chooser);
  gtk_box_pack_start (GTK_BOX (hbox), button, FALSE, FALSE, 0);

  /* "Start" button */
  button = expidus_gtk_button_new_mixed ("", _("Start"));
  gtk_widget_set_tooltip_text (button, _("Start an existing session."));
  gtk_style_context_add_class (gtk_widget_get_style_context (button), "suggested-action");
  gtk_dialog_set_default_response (GTK_DIALOG (chooser), ESSM_RESPONSE_LOAD);
  g_signal_connect (G_OBJECT (button), "clicked",
                    G_CALLBACK (essm_chooser_start_session), chooser);
  gtk_box_pack_start (GTK_BOX (hbox), button, FALSE, FALSE, 0);
...
static void
essm_chooser_row_activated (GtkTreeView       *treeview,
                            GtkTreePath       *path,
                            GtkTreeViewColumn *column,
                            EssmChooser       *chooser)
{
...
static void
essm_chooser_realized (GtkWidget   *widget,
                       EssmChooser *chooser)
{
  GdkCursor *cursor;
